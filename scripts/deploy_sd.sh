...
[ -f wince/tuner/mero-tuner.exe ] && cp -v wince/tuner/mero-tuner.exe "$SD_MOUNT/MERO/mero-tuner.exe"
[ -f wince/media/mero-media-ctrl.exe ] && cp -v wince/media/mero-media-ctrl.exe "$SD_MOUNT/MERO/mero-media-ctrl.exe"
